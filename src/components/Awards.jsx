        ...
        <div className="bg-primary">
            ...
            <VerticalTimelineElement
                ...
                >
                    ...
                    <p>
                        Won two blockchain-based award categories for Hack The North, Canada's largest hackathon. We developed DAG, a project to aid ML developers with getting datasets via crowdsourcing.
                    </p>
                </VerticalTimelineElement>
                <VerticalTimelineElement
                    className="vertical-timeline-element--work"
